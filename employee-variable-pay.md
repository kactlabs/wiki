...
* The Variable Pay shall **not be payable on a monthly basis**, but will instead be **deferred and accrued** until Kactii reaches a **minimum cumulative funding milestone of one hundred fifty thousand U.S. dollars (USD $150,000)** (the “Funding Threshold”).
* Once the Funding Threshold is achieved, Kactii shall **release the accrued Variable Pay** to eligible employees in **twelve (12) equal monthly installments** beginning from the first payroll cycle following the funding milestone.
